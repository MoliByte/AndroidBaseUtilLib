...
public class SuperToast {
     ...
     * {@link com.base.supertoasts.util.OnClickWrapper}
     */
     ...
     * SuperActivityToasts/SuperCardToasts must use this with an
     * {@link com.base.supertoasts.util.OnDismissWrapper}
     */
    ...
    public static class Icon {
        ...
        public static class Dark {
            ...
            public static final int EDIT = (R.drawable.toast_icon_dark_edit);
            public static final int EXIT = (R.drawable.toast_icon_dark_exit);
            public static final int INFO = (R.drawable.toast_icon_dark_info);
            public static final int REDO = (R.drawable.toast_icon_dark_redo);
            public static final int REFRESH = (R.drawable.toast_icon_dark_refresh);
            public static final int SAVE = (R.drawable.toast_icon_dark_save);
            public static final int SHARE = (R.drawable.toast_icon_dark_share);
            public static final int UNDO = (R.drawable.toast_icon_dark_undo);
        ...
        public static class Light {
            ...
            public static final int EDIT = (R.drawable.toast_icon_light_edit);
            public static final int EXIT = (R.drawable.toast_icon_light_exit);
            public static final int INFO = (R.drawable.toast_icon_light_info);
            public static final int REDO = (R.drawable.toast_icon_light_redo);
            public static final int REFRESH = (R.drawable.toast_icon_light_refresh);
            public static final int SAVE = (R.drawable.toast_icon_light_save);
            public static final int SHARE = (R.drawable.toast_icon_light_share);
            public static final int UNDO = (R.drawable.toast_icon_light_undo);
    ...
    public SuperToast(Context context) {
        ...
        mToastView = layoutInflater.inflate(R.layout.toast_supertoast, null);
     ...
     *
     * @param iconResource {@link com.base.supertoasts.SuperToast.Icon}
     ...
     *
     * @param onDismissListener {@link com.base.supertoasts.SuperToast.OnDismissListener}
     */
     ...
     *
     * @return {@link com.base.supertoasts.SuperToast.OnDismissListener}
     */

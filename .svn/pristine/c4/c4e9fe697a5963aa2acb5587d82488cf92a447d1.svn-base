...
import com.base.supertoasts.SuperToast.Animations;
import com.base.supertoasts.SuperToast.IconPosition;
import com.base.supertoasts.SuperToast.Type;
...
import com.base.supertoasts.util.SwipeDismissListener;
...
public class SuperCardToast {
    ...
    private int mIcon;
    private int mBackground = (R.drawable.toast_background_standard_gray);
    ...
    public SuperCardToast(Activity activity) {
        ...
        mToastView = mLayoutInflater
                .inflate(R.layout.toast_supercardtoast, mViewGroup, false);
     ...
     *
     * @param activity     {@link android.app.Activity}
     * @param style {@link com.base.supertoasts.util.Style}
     */
    @SuppressWarnings("ConstantConditions")
     ...
     *
     * @param activity {@link android.app.Activity}
     * @param type     {@link com.base.supertoasts.SuperToast.Type}
     */
    @SuppressWarnings("ConstantConditions")
    public SuperCardToast(Activity activity, Type type) {
        ...
        if (type == Type.BUTTON) {
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.toast_supercardtoast_button, mViewGroup, false);
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.toast_supercardtoast_progresscircle, mViewGroup, false);
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.toast_supercardtoast_progresshorizontal, mViewGroup, false);
    ...
    /**
     * Returns the {@link com.base.supertoasts.SuperToast.Type} of {@value #TAG}.
     *
     * @return {@link com.base.supertoasts.SuperToast.Type}
     */
    public Type getType() {
     ...
     *
     * @param duration {@link com.base.supertoasts.SuperToast.Duration}
     */
     ...
     *
     * @param icon         {@link com.base.supertoasts.SuperToast.Icon}
     * @param iconPosition {@link com.base.supertoasts.SuperToast.IconPosition}
     */
     ...
     *
     * @return {@link com.base.supertoasts.SuperToast.IconPosition}
     */
     ...
     *
     * @param background {@link com.base.supertoasts.SuperToast.Background}
     */
    ...
    private int checkForKitKatBackgrounds(int background) {
        ...
        if(background == R.drawable.toast_background_kitkat_black) {

            return (R.drawable.toast_background_standard_black);

        } else if(background == R.drawable.toast_background_kitkat_blue) {

            return (R.drawable.toast_background_standard_blue);

        } else if(background == R.drawable.toast_background_kitkat_gray) {

            return (R.drawable.toast_background_standard_gray);

        } else if(background == R.drawable.toast_background_kitkat_green) {

            return (R.drawable.toast_background_standard_green);

        } else if(background == R.drawable.toast_background_kitkat_orange) {

            return (R.drawable.toast_background_standard_orange);

        } else if(background == R.drawable.toast_background_kitkat_purple) {

            return (R.drawable.toast_background_standard_purple);

        } else if(background == R.drawable.toast_background_kitkat_red) {

            return (R.drawable.toast_background_standard_red);

        } else if(background == R.drawable.toast_background_kitkat_white) {

            return (R.drawable.toast_background_standard_white);
     ...
     *
     * @param animations {@link com.base.supertoasts.SuperToast.Animations}
     */
     ...
     *
     * @return {@link com.base.supertoasts.SuperToast.Animations}
     */
     ...
     * to the {@value #TAG}.
     *
     * @param onDismissWrapper {@link com.base.supertoasts.util.OnDismissWrapper}
     */
     ...
     * a BUTTON {@link com.base.supertoasts.SuperToast.Type} {@value #TAG}.
     *
     * @param onClickWrapper {@link com.base.supertoasts.util.OnClickWrapper}
     */
     ...
     * {@link com.base.supertoasts.SuperToast.Type} {@value #TAG}.
     *
     * @param onClickWrapper {@link com.base.supertoasts.util.OnClickWrapper}
     ...
     * a BUTTON {@link com.base.supertoasts.SuperToast.Type} {@value #TAG}.
     *
     * @param buttonIcon {@link com.base.supertoasts.SuperToast.Icon}
     */
     ...
     * @param durationInteger  {@link com.base.supertoasts.SuperToast.Duration}
     *
     ...
     * @param bundle          Use onCreate() bundle
     * @param activity        The current activity
     * @param wrappers        {@link com.base.supertoasts.util.Wrappers}
     */

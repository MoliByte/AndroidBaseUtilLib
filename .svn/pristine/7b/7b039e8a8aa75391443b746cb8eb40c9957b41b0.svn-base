...
public class Style {
    ...
    public static int getBackground(int style) {
        ...
        if(Build.VERSION.SDK_INT >= 17/* Build.VERSION_CODES.KITKAT*/) {

            switch (style) {

                case BLACK:

                    return (R.drawable.toast_background_kitkat_black);

                case WHITE:

                    return (R.drawable.toast_background_kitkat_white);

                case GRAY:

                    return (R.drawable.toast_background_kitkat_gray);

                case PURPLE:

                    return (R.drawable.toast_background_kitkat_purple);

                case RED:

                    return (R.drawable.toast_background_kitkat_red);

                case ORANGE:

                    return (R.drawable.toast_background_kitkat_orange);

                case BLUE:

                    return (R.drawable.toast_background_kitkat_blue);

                case GREEN:

                    return (R.drawable.toast_background_kitkat_green);

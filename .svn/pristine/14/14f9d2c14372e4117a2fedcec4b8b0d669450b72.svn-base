...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder(Context context,int theme,int resource_layout_id) {
    	super(context, theme);
    	init(context,resource_layout_id);
    }
    ...
    public static NiftyDialogBuilder getInstance(Context context,int resource_layout_id) {
    	instance = new NiftyDialogBuilder(context,R.style.dialog_untran,resource_layout_id);
    	return instance;
    ...
    private void init(Context context) {
        ...
        mDialogView = View.inflate(context, R.layout.dialog_comfirmed_with_two_options_layout, null);
     ...
     * 自定义加载dialog
     * */
    private void init(Context context,int resource_layout_id) {
    	
    	mDialogView = View.inflate(context, resource_layout_id, null);
    	 mLinearLayoutView=(LinearLayout)mDialogView.findViewById(R.id.parentPanel);
         mRelativeLayoutView=(RelativeLayout)mDialogView.findViewById(R.id.main);
         mLinearLayoutTopView=(LinearLayout)mDialogView.findViewById(R.id.topPanel);
         mLinearLayoutMsgView=(LinearLayout)mDialogView.findViewById(R.id.contentPanel);
